...
filename = "model_classif_balanced.txt"
...
header = np.genfromtxt('../data/augmented_train_data_format_weka.csv',dtype=str,delimiter=',')
header = header[0]
...
#data_full_test = np.loadtxt('../data/augmented_test_data_format_weka',delimiter=',',skiprows=1)
...
#subprocess.call(["java -cp ~/weka/weka-3-8-1/weka.jar weka.classifiers.trees.J48 -t ../data/augmented_train_data_format_weka.arff -T ../data/test_format_weka.arff -C 0.25 -M 2 -d j48.model -o > ../changing_params/expe_final_retrain_python/eval_stat_balanced.txt"],shell=True)
subprocess.call(["java -cp ~/weka/weka-3-8-1/weka.jar weka.classifiers.trees.J48 -t ../data/augmented_train_data_format_weka.arff -T ../data/augmented_test_data_format_weka.arff -C 0.25 -M 2 -d j48.model -o > ../changing_params/expe_final_retrain_python/eval_stat_balanced_augmented.txt"],shell=True)

##save tree in order to extract constraints
#subprocess.call(["java -cp ~/weka/weka-3-8-1/weka.jar weka.classifiers.trees.J48 -t ../data/augmented_train_data_format_weka.arff -T ../data/test_format_weka.arff -C 0.25 -M 2 -d j48.model -g > ../changing_params/expe_final_retrain_python/init_tree_balanced.txt"],shell=True)
subprocess.call(["java -cp ~/weka/weka-3-8-1/weka.jar weka.classifiers.trees.J48 -t ../data/augmented_train_data_format_weka.arff -T ../data/augmented_test_data_format_weka.arff -C 0.25 -M 2 -d j48.model -g > ../changing_params/expe_final_retrain_python/init_tree_balanced_augmented.txt"],shell=True)
...
for stp in step:
    ...
    for it in range(0,10):
        ...
        clf.fit(data,value)
        #filename = "../changing_params/expe_final_retrain_python/model_classif_after_retrain_epoch_"+str(nb_epochs)+"_with_step_"+str(stp)+"_final_norm_balanced.txt"
        filename = "../changing_params/expe_final_retrain_python/model_classif_after_retrain_epoch_"+str(nb_epochs)+"_with_step_"+str(stp)+"_final_norm_balanced_augmented.txt"
        ...
        #df.to_csv("../changing_params/expe_final_retrain_python//csv/data_after_attack_1_epochs_"+str(max_disp)+"_iter_"+str(nb_init_pts)+"_pts_"+str(stp)+"_eps_"+str(it+1)+"_iter_norm_balanced.csv",header=header,index=False)
        df.to_csv("../changing_params/expe_final_retrain_python//csv/data_after_attack_1_epochs_"+str(max_disp)+"_iter_"+str(nb_init_pts)+"_pts_"+str(stp)+"_eps_"+str(it+1)+"_iter_norm_balanced_augmented.csv",header=header,index=False)
        ...
        #subprocess.call(["java -cp ~/weka/weka-3-8-1/weka.jar weka.core.converters.CSVLoader ../changing_params/expe_final_retrain_python/csv/data_after_attack_1_epochs_"+str(max_disp)+"_iter_"+str(nb_init_pts)+"_pts_"+str(stp)+"_eps_"+str(it+1)+"_iter_norm_balanced.csv > ../changing_params/expe_final_retrain_python/arff/data_after_attack_1_epochs_"+str(max_disp)+"_iter_"+str(nb_init_pts)+"_pts_"+str(stp)+"_eps_"+str(it+1)+"_iter_norm_balanced.arff"],shell=True)
        subprocess.call(["java -cp ~/weka/weka-3-8-1/weka.jar weka.core.converters.CSVLoader ../changing_params/expe_final_retrain_python/csv/data_after_attack_1_epochs_"+str(max_disp)+"_iter_"+str(nb_init_pts)+"_pts_"+str(stp)+"_eps_"+str(it+1)+"_iter_norm_balanced_augmented.csv > ../changing_params/expe_final_retrain_python/arff/data_after_attack_1_epochs_"+str(max_disp)+"_iter_"+str(nb_init_pts)+"_pts_"+str(stp)+"_eps_"+str(it+1)+"_iter_norm_balanced_augmented.arff"],shell=True)
        print("end convert csv to arff")

        #fi = fileinput.input("../changing_params/expe_final_retrain_python/arff/data_after_attack_1_epochs_"+str(max_disp)+"_iter_"+str(nb_init_pts)+"_pts_"+str(stp)+"_eps_"+str(it+1)+"_iter_norm_balanced.arff",inplace=True)
        fi = fileinput.input("../changing_params/expe_final_retrain_python/arff/data_after_attack_1_epochs_"+str(max_disp)+"_iter_"+str(nb_init_pts)+"_pts_"+str(stp)+"_eps_"+str(it+1)+"_iter_norm_balanced_augmented.arff",inplace=True)
        for line in fi:
        ...
        print("begin eval")
        #subprocess.call(["java -cp ~/weka/weka-3-8-1/weka.jar weka.classifiers.trees.J48 -t ../changing_params/expe_final_retrain_python/arff/data_after_attack_1_epochs_"+str(max_disp)+"_iter_"+str(nb_init_pts)+"_pts_"+str(stp)+"_eps_"+str(it+1)+"_iter_norm_balanced.arff -T ../data/test_format_weka.arff -C 0.25 -M 2 -d j48.model -o > ../changing_params/expe_final_retrain_python/eval_stat_after_attack_1_epochs_"+str(nb_init_pts)+"_pts_"+str(it+1)+"_disp_"+str(max_disp)+"_stp_"+str(stp)+"_norm_balanced.txt"],shell=True,timeout=900)
        subprocess.call(["java -cp ~/weka/weka-3-8-1/weka.jar weka.classifiers.trees.J48 -t ../changing_params/expe_final_retrain_python/arff/data_after_attack_1_epochs_"+str(max_disp)+"_iter_"+str(nb_init_pts)+"_pts_"+str(stp)+"_eps_"+str(it+1)+"_iter_norm_balanced.arff -T ../data/augmented_test_data_format_weka.arff -C 0.25 -M 2 -d j48.model -o > ../changing_params/expe_final_retrain_python/eval_stat_after_attack_1_epochs_"+str(nb_init_pts)+"_pts_"+str(it+1)+"_disp_"+str(max_disp)+"_stp_"+str(stp)+"_norm_balanced_augmented.txt"],shell=True,timeout=900)

        print("begin tree")
        ##save tree in order to extract constraints
        #subprocess.call(["java -cp ~/weka/weka-3-8-1/weka.jar weka.classifiers.trees.J48 -t ../changing_params/expe_final_retrain_python/arff/data_after_attack_1_epochs_"+str(max_disp)+"_iter_"+str(nb_init_pts)+"_pts_"+str(stp)+"_eps_"+str(it+1)+"_iter_norm_balanced.arff -T ../data/test_format_weka.arff -C 0.25 -M 2 -d j48.model -g > ../changing_params/expe_final_retrain_python/tree_after_attack_"+str(nb_init_pts)+"_pts_"+str(it+1)+"_disp_"+str(max_disp)+"_stp_"+str(stp)+"_norm_balanced.txt"],shell=True,timeout=900)
        subprocess.call(["java -cp ~/weka/weka-3-8-1/weka.jar weka.classifiers.trees.J48 -t ../changing_params/expe_final_retrain_python/arff/data_after_attack_1_epochs_"+str(max_disp)+"_iter_"+str(nb_init_pts)+"_pts_"+str(stp)+"_eps_"+str(it+1)+"_iter_norm_balanced.arff -T ../data/augmented_test_data_format_weka.arff -C 0.25 -M 2 -d j48.model -g > ../changing_params/expe_final_retrain_python/tree_after_attack_"+str(nb_init_pts)+"_pts_"+str(it+1)+"_disp_"+str(max_disp)+"_stp_"+str(stp)+"_norm_balanced_augmented.txt"],shell=True,timeout=900)
