...
#files=listdir("../result_perf_100_runs/all_config_pt/adv_attack/")
#f= 


##adv attack
#filenames=glob.glob("../result_perf_100_runs/all_config_pt/adv_attack_norm/balanced_*20.csv")
#filenames=glob.glob("../result_perf_100_runs/all_config_pt/adv_attack_norm/balanced_*50.csv")
#filenames=glob.glob("../result_perf_100_runs/all_config_pt/adv_attack_norm/balanced_*100.csv")
##random attack
#filenames=glob.glob("../result_perf_100_runs/all_config_pt/random_attack_norm/balanced_*20.csv")
#filenames=glob.glob("../result_perf_100_runs/all_config_pt/random_attack_norm/balanced_*50.csv")
filenames=glob.glob("../result_perf_100_runs/all_config_pt/random_attack_norm/balanced_*100.csv")
#print (filenames)
