...
##adv attack
#filenames=glob.glob("../result_perf_100_runs/all_config_pt/adv_attack_norm/*20.csv")
#filenames=glob.glob("../result_perf_100_runs/all_config_pt/adv_attack_norm/*50.csv")
#filenames=glob.glob("../result_perf_100_runs/all_config_pt/adv_attack_norm/*100.csv")
##random attack
#filenames=glob.glob("../result_perf_100_runs/all_config_pt/random_attack_norm/*20.csv")
#filenames=glob.glob("../result_perf_100_runs/all_config_pt/random_attack_norm/*50.csv")
filenames=glob.glob("../result_perf_100_runs/all_config_pt/random_attack_norm/*100.csv")
#print (filenames)
