...
##adv attack
#filenames=glob.glob("../result_perf_100_runs/all_config_pt/adv_attack_norm/balanced_*_20_label_nonacc.csv")
#filenames=glob.glob("../result_perf_100_runs/all_config_pt/adv_attack_norm/balanced_*50_label_nonacc.csv")
#filenames=glob.glob("../result_perf_100_runs/all_config_pt/adv_attack_norm/balanced_*100_label_nonacc.csv")
##random attack
#filenames=glob.glob("../result_perf_100_runs/all_config_pt/random_attack_norm/balanced_*20_nonacc.csv")
#filenames=glob.glob("../result_perf_100_runs/all_config_pt/random_attack_norm/balanced_*50_nonacc.csv")
filenames=glob.glob("../result_perf_100_runs/all_config_pt/random_attack_norm/balanced_*100_nonacc.csv")
#print (filenames)
